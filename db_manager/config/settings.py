...
# Refresh Flow Exceedance MV schedule (nightly at 4:00 AM Rome time) - disabled
# FLOW_EXCEEDANCE_MV_REFRESH_HOUR = 4  # 4 AM
# FLOW_EXCEEDANCE_MV_REFRESH_MINUTE = 0
# FLOW_EXCEEDANCE_MV_REFRESH_TZ = "Europe/Rome"

# Refresh Hourly Raw Duration Curve MV schedule (nightly at 4:00 AM Rome time)
HOURLY_RAW_DURATION_CURVE_MV_REFRESH_HOUR = 4  # 4 AM
HOURLY_RAW_DURATION_CURVE_MV_REFRESH_MINUTE = 0
HOURLY_RAW_DURATION_CURVE_MV_REFRESH_TZ = "Europe/Rome"

# Refresh Flow Histogram Hours MV schedule (nightly at 5:00 AM Rome time)
FLOW_HISTOGRAM_HOURS_MV_REFRESH_HOUR = 5  # 5 AM
FLOW_HISTOGRAM_HOURS_MV_REFRESH_MINUTE = 0
FLOW_HISTOGRAM_HOURS_MV_REFRESH_TZ = "Europe/Rome"
